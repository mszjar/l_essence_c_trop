...
p "---------Créations des titres notes----------"
titles_review = ["Trop belle cette caisse", "Le bruit de l'électrique est incroyable", "On va plus vite que l'éclair", "FlashMcQuenn était moins rapide que moi","Petite virée avec Picsou, c'était intense","Pas de bruits, super agréable","VIVE LES ENERGIES VERTES !! ","L'essence c'est trop !!!! Giga expérience", "Impressionant le calme", "A mort le gasoile, vive l'électricité", "C'est qui ce Francis qui a 20 voitures en location sur le site", "Pourquoi les gens continuent de rouler avec de l'essence", "Elon je t'aime", "Hugo est très lent aux échecs par rapport aux voitures électriques", "J'aime pas les bagnoles mais les électriques sont top ! Giga chad", "Ma barbe ne tremblait même pas dans la voiture","Les voitures électriques ça m'excite, j'ai envie de me déshabiller dedans", "Ouhahahhhhhh trop bien"]
...
car = Car.create!(brand: "Aiways", model: "U5", color: "Gris",
                  city: "Rue de la Metge, 81370 Saint-Sulpice-la-Pointe", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Audi", model: "Q8 e-tron", color: "Blanc",
                  city: "Rue Champfleuri, 63100 Clermont-Ferrand", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Audi", model: "Q8 e-tron Sportback", color: "Rouge",
                  city: "Avenue Marc Sangnier, 69100 Villeurbanne", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Baojun", model: "E300", color: "Blanc",
                  city: "Rue le Val Sérine, 01410 Mijoux", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "BMW", model: "i3", color: "Blanc",
                  city: "Rue de l'Église, 13000 Marseille", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Chevrolet", model: "Bolt EV", color: "Gris foncé",
                  city: "Rue Coupé d'Or, 54470 Thiaucourt-Regniéville", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Cupra", model: "Born", color: "Gris",
                  city: "Rue Delaroche, 62100 Calais", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Citroën", model: "e-Méhari", color: "Vert anis",
                  city: "Rue de Crimée, 76130 Mont-Saint-Aignan", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Fiat", model: "500e", color: "Bleu marine",
                  city: "Rue de Ménilmontant, 75020 Paris", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Ford", model: "Mustang Mach-E", color: "Blanc",
                  city: "Rue de l'Ancien Porche, 35690 Acigné", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Lexus", model: "UX", color: "Gris",
                  city: "Rue Marguerite Allar, 13013 Marseille", kilometreage: Faker::Vehicle.kilometrage,
                  price: 60, autonomy: 315, user: francis)
car.photo.attach(io: file, filename: "lexus-ux.jpg", content_type: "image/jpg")
car.save

6.times do
  Review.create!(content: Faker::Restaurant.review, rating: [3, 4, 5].sample, car_id: car.id, title: titles_review.sample, user_id: jordan.id)
end
...
car = Car.create!(brand: "Mercedes-Benz", model: "EQB", color: "Gris foncé",
                  city: "Cr Carbonnet, 59000 Lille", kilometreage: Faker::Vehicle.kilometrage,
...
car = Car.create!(brand: "Renault", model: "Zoé", color: "Blanche", city: "Avenue de la République, 13000 Marseille",
                  kilometreage: Faker::Vehicle.kilometrage,
